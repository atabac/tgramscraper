        ...
        with open('config.txt', 'ab') as g:
            ...
            while True:
                ...
                if 'y' in ab:
                    ...
                    print('\n'+lg+'[i] Saved all accounts in config.txt'+n)
                    g.close()
                    sleep(3)
                    clr()
                    print(lg + '[*] Logging in from new accounts...\n')
                    for added in newly_added:
                        c = TelegramClient(added[2], added[0], added[1])
                        try:
                            c.start()
